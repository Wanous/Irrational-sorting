...
class SortingVisualizer:
    def __init__(self, root):
        ...
        self.images = {'Button_startOn':  tk.PhotoImage(file="sources/ressources/images/Boutton_start_ON.png"),
                       ...
                       'Pi π':  {'image' : tk.PhotoImage(file="sources/ressources/images/Pi.png"),'file' : 'sources/ressources/decimals/pi.txt'},
                       'Phi ϕ': {'image' : tk.PhotoImage(file="sources/ressources/images/Phi.png"),'file' : 'sources/ressources/decimals/phi.txt'},
                       "Euler's constant e":  {'image' : tk.PhotoImage(file="sources/ressources/images/Euler_constant.png"),'file' : 'sources/ressources/decimals/e.txt'},
                       "Champernowne's constant C10": {'image' : tk.PhotoImage(file="sources/ressources/images/Champernowne_constant.png"),'file' : 'sources/ressources/decimals/Champernowne.txt'}}
        ...
        self.combobox = ttk.Combobox(self.controls_frame,
                                     state="readonly",
                                     values=["Pi π", "Phi ϕ", "Euler's constant e","Champernowne's constant C10"],
                                     width=30)
        ...
        self.Irrational_image.create_image(25,25, image=self.images['Pi π']['image'],anchor=tk.CENTER)
